...
export default function DashboardPage() {
  ...
  const wrongNetworkBanner = !isCorrectNetwork && (
    <div className="mb-6 flex items-center gap-3 rounded-xl border border-amber-300 bg-amber-50 px-4 py-3 text-sm text-amber-800 dark:border-amber-700 dark:bg-amber-950/30 dark:text-amber-300">
