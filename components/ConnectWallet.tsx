...
import { Wallet, WifiOff, AlertTriangle } from 'lucide-react';
  ...
  if (!isCorrectNetwork) {
    return (
      <div className="flex items-center gap-3">
        <div className="flex items-center gap-2 rounded-lg border border-amber-300 bg-amber-50 px-3 py-1.5 text-sm text-amber-800">
